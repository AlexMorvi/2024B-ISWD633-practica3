...
es /var/lib/docker/volumes/vol-postgres/_data
...
```
docker run -d --name client-postgres --publish published=9500,target=80 -e PGADMIN_DEFAULT_PASSWORD=54321 -e PGADMIN_DEFAULT_EMAIL=ariel.morales@epn.edu.ec --network net-drupal dpage/pgadmin4
